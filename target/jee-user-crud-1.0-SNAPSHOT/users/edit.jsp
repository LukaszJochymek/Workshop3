...
<form action="/UserEdit" method="post">
    ...
    <div class="form-group">
        ...
        <input type="name" value="${param.userName}" name="name" class="form-control" id="exampleInputEmail1"
               aria-describedby="nameHelp">
        <small id="nameHelp" class="form-text text-muted">podaj nazwe użytkownika</small>
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Email address</label>
        <input type="email" value="${param.email}" name="email" class="form-control" id="exampleInputEmail1"
